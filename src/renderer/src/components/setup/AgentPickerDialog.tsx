...
interface AgentPickerDialogProps {
  onSelect: (sdk: 'opencode' | 'claude-code' | 'codex' | 'omx') => void
  availableSdks: { opencode: boolean; claude: boolean; codex: boolean; omx: boolean }
}
      ...
      <AlertDialogContent>
        ...
        <div className="flex gap-3 pt-2">
          ...
          {availableSdks.omx && (
            ...
            >
              <div className="text-sm font-medium">OMX</div>
              <div className="text-xs text-muted-foreground mt-1">
                tmux-backed Oh My Codex workflow
              </div>
            </button>
          )}
        </div>
